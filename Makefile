...
# Generated by qmake (2.01a) (Qt 4.8.6) on: ven ott 10 16:15:29 2014
# Project:  CPPiano.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile CPPiano.pro
#############################################################################
...
INCPATH       = -I/usr/include/qt4/QtMultimedia -I/usr/include/qt4/QtMultimediaKit  -I/usr/include/QtMobility -I/usr/share/qt4/mkspecs/linux-g++-64 -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4 -I. -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
...
moc_audiooutputstreamer.cpp: audiooutputstreamer.hpp
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) audiooutputstreamer.hpp -o moc_audiooutputstreamer.cpp

moc_key.cpp: audiooutputstreamer.hpp \
		key.hpp
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) key.hpp -o moc_key.cpp

moc_keyboard.cpp: key.hpp \
		audiooutputstreamer.hpp \
		keyboard.hpp
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) keyboard.hpp -o moc_keyboard.cpp
